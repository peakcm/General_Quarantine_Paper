#### Header #### 
# Ebola Case Study for Generalized Study of Quarantine vs Symptom Monitoring
# Corey Peak
# Version 1.0
# August 25, 2015
...
# write.table(ks_conv_stat, "20150829_Ebola_ParticleFilter.csv")
...
parms_d_symp = list("triangle", 1, 3, 2, "independent", "independent")
names(parms_d_symp) <- c("dist","parm1","parm2",  "parm3","anchor_value", "anchor_target")
...
params.set <- cbind(
  ...
  d_symp_peak = data[sample, "d_symp_peak"],
  d_symp_max = data[sample, "d_symp_max"],
...
for (i in 1:times){
  ...
  parms_d_symp$parm2 <- params.set[i,"d_symp_max"]
  parms_d_symp$parm3 <- parms_d_symp$parm1 + (parms_d_symp$parm2 - parms_d_symp$parm1)*params.set[i,"d_symp_peak"]
...
data.hr$d_symp_peak_vector <- params.set[,"d_symp_peak"]
data.hr$d_symp_max_vector <- params.set[,"d_symp_max"]
...
layout(cbind(c(1,2,3),c(4,5,6)))
plot(data.hr$d_symp_peak_vector, data.hr$R_0, ylim=c(0, max(data.hr$R_0)))
plot(data.hr$d_symp_peak_vector, data.hr$R_s, ylim=c(0, max(data.hr$R_0)))
plot(data.hr$d_symp_peak_vector, data.hr$R_q, ylim=c(0, max(data.hr$R_0)))
plot(data.hr$d_symp_peak_vector, log10(data.hr$NNQ))
plot(data.hr$d_symp_peak_vector, data.hr$Abs_Benefit)
plot(data.hr$d_symp_peak_vector, data.hr$Abs_Benefit_per_Qday, ylim=c(-0.4, 0.4))

layout(cbind(c(1,2,3),c(4,5,6)))
plot(data.hr$d_symp_max_vector, data.hr$R_0, ylim=c(0, max(data.hr$R_0)))
plot(data.hr$d_symp_max_vector, data.hr$R_s, ylim=c(0, max(data.hr$R_0)))
plot(data.hr$d_symp_max_vector, data.hr$R_q, ylim=c(0, max(data.hr$R_0)))
plot(data.hr$d_symp_max_vector, log10(data.hr$NNQ))
plot(data.hr$d_symp_max_vector, data.hr$Abs_Benefit)
plot(data.hr$d_symp_max_vector, data.hr$Abs_Benefit_per_Qday, ylim=c(-0.4, 0.4))
...
data.lr$d_symp_peak_vector <- params.set[,"d_symp_peak"]
data.lr$d_symp_max_vector <- params.set[,"d_symp_max"]
...
layout(cbind(c(1,2,3),c(4,5,6)))
plot(data.lr$d_symp_peak_vector, data.lr$R_0, ylim=c(0, max(data.lr$R_0)))
plot(data.lr$d_symp_peak_vector, data.lr$R_s, ylim=c(0, max(data.lr$R_0)))
plot(data.lr$d_symp_peak_vector, data.lr$R_q, ylim=c(0, max(data.lr$R_0)))
plot(data.lr$d_symp_peak_vector, log10(data.lr$NNQ))
plot(data.lr$d_symp_peak_vector, data.lr$Abs_Benefit)
plot(data.lr$d_symp_peak_vector, data.lr$Abs_Benefit_per_Qday, ylim=c(-0.4, 0.4))

layout(cbind(c(1,2,3),c(4,5,6)))
plot(data.lr$d_symp_max_vector, data.lr$R_0, ylim=c(0, max(data.lr$R_0)))
plot(data.lr$d_symp_max_vector, data.lr$R_s, ylim=c(0, max(data.lr$R_0)))
plot(data.lr$d_symp_max_vector, data.lr$R_q, ylim=c(0, max(data.lr$R_0)))
plot(data.lr$d_symp_max_vector, log10(data.lr$NNQ))
plot(data.lr$d_symp_max_vector, data.lr$Abs_Benefit)
plot(data.lr$d_symp_max_vector, data.lr$Abs_Benefit_per_Qday, ylim=c(-0.4, 0.4))
